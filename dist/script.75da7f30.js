...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"get.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.currentConditions = void 0;
...
var currentConditions = exports.currentConditions = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(zipCode) {
    var response, data, locationKey, fiveDayForecastResponse, fiveDayForecast, dataTable, city, weatherTable, tableHeaders, dateHeader, forecastHeader, tempHeader;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch("http://dataservice.accuweather.com/locations/v1/postalcodes/search?apikey=A0eLxjDMQC919yA8VukwvzicrL5uZqGk&q=".concat(zipCode));
        case 3:
        ...
        case 6:
          data = _context.sent;
          locationKey = data[0].ParentCity.Key;
          _context.next = 10;
          return fetch("http://dataservice.accuweather.com/forecasts/v1/daily/5day/".concat(locationKey, "?apikey=A0eLxjDMQC919yA8VukwvzicrL5uZqGk"));
        case 10:
          fiveDayForecastResponse = _context.sent;
          _context.next = 13;
          return fiveDayForecastResponse.json();
        case 13:
          fiveDayForecast = _context.sent;
          //document.getElementById("greeting").innerHTML = "";
          dataTable = document.getElementById("data-table");
          dataTable.innerHTML = "";
          city = document.createElement("h1").innerHTML = data[0].LocalizedName + " weather forecast for the next five days";
          ...
          forecastHeader = document.createElement("th");
          tempHeader = document.createElement("th"); //const windHeader = document.createElement("th");
          ...
          fiveDayForecast.DailyForecasts.forEach(function (dailyForecast) {
  ...
  return function currentConditions(_x) {
    return _ref.apply(this, arguments);
  };
}();
},{}],"put.js":[function(require,module,exports) {
"use strict";
...
var uploadJson = exports.uploadJson = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(fileContent) {
    var url, options, response, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = 'https://json-store.p.rapidapi.com/';
          options = {
            method: 'PUT',
            headers: {
...
document.getElementById("search-btn").addEventListener("click", function () {
  ...
  (0, _get.currentConditions)(zipCode);
}, false);
...
document.getElementById("json-upload").addEventListener("change", function () {
  ...
  reader.onload = function () {
    (0, _put.uploadJson)(reader.result);
  };
...
//currentConditions(zip);
},{"./get":"get.js","./put":"put.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
